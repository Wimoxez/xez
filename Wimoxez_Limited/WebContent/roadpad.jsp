...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="roadpad/css/bootstrap.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="roadpad/css/main.css" rel="stylesheet">
    <link rel="stylesheet" href="roadpad/css/icomoon.css">
    <link href="roadpad/css/animate-custom.css" rel="stylesheet">
    ...
    <script src="roadpad/js/jquery.min.js"></script>
	<script type="text/javascript" src="roadpad/js/modernizr.custom.js"></script>
 ...
 .navbar-default,
  ...
  <body data-spy="scroll" data-offset="0" data-target="#navbar-main">
    ...
    <div class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand hidden-xs hidden-sm" href="#home"><span class="" style="font-size:18px; color:#3498db;"></span><img src="roadpad/img/rplogo.png" height="35px" width= "180px"></a>
        </div>
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
           <li class="dropdown">
     	 				<a class="dropdown-toggle" data-toggle="dropdown" href="#">Early Users<span class="caret"></span></a>
			 ...
			 <li class="dropdown">
     	 				<a class="dropdown-toggle" data-toggle="dropdown" href="#">Product Demo<span class="caret"></span></a>
      						 <ul class="dropdown-menu">
      						 <li><a href="#">All</a></li>
			 ...
			 <li class="dropdown">
     	 				<a class="dropdown-toggle" data-toggle="dropdown" href="#">Launching<span class="caret"></span></a>
      						 <ul class="dropdown-menu">
			...
			<li> <a href="support.jsp" class="smoothScroll">Support</a></li>
			</ul>
		...
		<div class="container" id="services" name="services">
			...
			<div class="row">
				...
				<br>
				<div class="col-lg-offset-2 col-lg-8">
					<img class="img-responsive" src="roadpad/img/iphone.png" alt="">
				</div><!-- col -->
			</div><!-- row -->
		</div><!-- container -->
		...
		<br>
			<div class="row white centered">
				...
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="roadpad/img/team/team01.jpg" height="120px" width="120px" alt="">
					<br>
				...
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="roadpad/img/team/team02.jpg" height="120px" width="120px" alt="">
					<br>
				...
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="roadpad/img/team/team03.jpg" height="120px" width="120px" alt="">
					<br>
				...
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="roadpad/img/team/team04.jpg" height="120px" width="120px" alt="">
					<br>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 centered">
						<img class="img-responsive" src="roadpad/img/macbook.png" align="">
					</div>
					<div class="col-lg-4">
						<h2>We Are Hiring!</h2>
		...
		<br>
			...
			<div class="row">	
				...
				<div class="col-md-4 ">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="roadpad/img/portfolio/folio01.jpg" alt="">
							<figcaption>
								<h5>DASHBOARD</h5>
						    ...
						    <div class="modal-dialog">
						      <div class="modal-content">
						        ...
						        <div class="modal-body">
						          <p><img class="img-responsive" src="roadpad/img/portfolio/folio01.jpg" alt=""></p>
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="roadpad/img/portfolio/folio02.jpg" alt="">
							<figcaption>
								<h5>UI DESIGN</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="roadpad/img/portfolio/folio03.jpg" alt="">
							<figcaption>
								<h5>ANDROID PAGE</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
			...
			<div class="row">	
				<div class="col-md-4 ">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="roadpad/img/portfolio/folio04.jpg" alt="">
							<figcaption>
								<h5>PROFILE</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="roadpad/img/portfolio/folio05.jpg" alt="">
							<figcaption>
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="roadpad/img/portfolio/folio06.jpg" alt="">
							<figcaption>
								<h5>PHONE MOCKUP</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
		...
		<br>
			...
			<div class="row">
				<div class="col-lg-6 blog-bg">
					...
					<br>
						<p><img class="img img-circle" src="roadpad/img/team/team04.jpg" width="60px" height="60px"></p>
						<h4>Jaye Smith</h4>
				...
				<div class="col-lg-6 blog-bg">
					<div class="col-lg-4 centered">
					<br>
						<p><img class="img img-circle" src="roadpad/img/team/team03.jpg" width="60px" height="60px"></p>
						<h4>Michele Lampa</h4>
	...
	<script type="text/javascript" src="roadpad/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="roadpad/js/retina.js"></script>
	<script type="text/javascript" src="roadpad/js/jquery.easing.1.3.js"></script>
    <script type="text/javascript" src="roadpad/js/smoothscroll.js"></script>
	<script type="text/javascript" src="roadpad/js/jquery-func.js"></script>
  </body>
</html>

...
<head>
    ...
    <!-- Bootstrap -->
    <link href="telp/css/bootstrap.css" rel="stylesheet">
    <link href="telp/css/font-awesome.css" rel="stylesheet">
    <link href="telp/css/bootstrap-theme.css" rel="stylesheet">
    <link rel="stylesheet" href="telp/css/animations.css">

    <!-- siimple style -->
    <link href="telp/css/style.css" rel="stylesheet">
...
<body>
    ...
    <div class="cloud floating">
        <img src="telp/img/cloud.png" alt="Scoop Themes">
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <img src="telp/img/logo.png" alt="Scoop Themes Logo">
                    <br/>
                    <br/>

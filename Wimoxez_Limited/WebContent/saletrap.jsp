...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    ================================================== -->
        ...
        <!-- Place favicon.ico and apple-touch-icon.png in the root directory -->
         ...
         ================================================== -->
        <!-- Bootstrap -->
        <link rel="stylesheet" href="salestrap/css/bootstrap.min.css"/>
        <!-- FontAwesome -->
        <link rel="stylesheet" href="salestrap/css/font-awesome.min.css"/>
        <!-- Animation -->
        <link rel="stylesheet" href="salestrap/css/animate.css" />
        <!-- Owl Carousel -->
        <link rel="stylesheet" href="salestrap/css/owl.carousel.css"/>
        <link rel="stylesheet" href="salestrap/css/owl.theme.css"/>
        <!-- Pretty Photo -->
        <link rel="stylesheet" href="salestrap/css/prettyPhoto.css"/>
        <!-- Main color style -->
        <link rel="stylesheet" href="salestrap/css/red.css"/>
        <!-- Template styles-->
        <link rel="stylesheet" href="salestrap/css/custom.css" />
        <!-- Responsive -->
        <link rel="stylesheet" href="salestrap/css/responsive.css" />
        <link rel="stylesheet" href="salestrap/css/jquery.fancybox.css?v=2.1.5" type="text/css" media="screen" />
                 ...
                 <div class="navbar-header ">
                     <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                        ...
                        <a class="navbar-brand" href="#">
                            <img src="salestrap/images/stlogo.png" alt="">
                        </a>
                 </div><!--Navbar header End-->
                 	<nav class="collapse navbar-collapse navigation" id="bs-example-navbar-collapse-1" role="navigation">
                        <ul class="nav navbar-nav navbar-right">
                           	<li class="active"> <a href="#slider_part" class="page-scroll">Features</a></li>
                            <li><a href="#service"  class="page-scroll">Get Product</a> </li>
                            <li><a href="#portfolio" class="page-scroll" >Pricing</a> </li>
                            <li><a href="#about" class="page-scroll">Support</a> </li>
           	...
           	<div class="carousel-inner">
           	 	<div class="item active">
           	 		<div class="overlay-slide">
           	 			<img src="salestrap/images/banner/p5.jpg" alt="" class="img-responsive">
           	 		</div>
                ...
                <div class="item">
                    <div class="overlay-slide">
                        <img src="salestrap/images/banner/p3.jpg" alt="" class="img-responsive">
           	 		</div>
           	 		<div class="carousel-caption">
               	 		<div class="col-md-12 col-xs-12 text-center">
                    <h2>Cyprass</h2>
           	 	...
           	 	<div class="item">
                    <div class="overlay-slide">
                        <img src="salestrap/images/banner/p10.jpg" alt="" class="img-responsive">
           	 		</div>
           	 		<div class="carousel-caption">
               	 		<div class="col-md-12 col-xs-12 text-center">
                    <h2>Cyprass</h2>
    ...
    <div class="clearfix"></div>
              ...
              <ul class="portfolio-wrap" id="portfolio_items">
                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio identity web-design">
                        <figure>
                            <img src="salestrap/images/portfolio/p1.jpg" alt="" />
                            <figcaption>
                                <h5>Creative Zoe</h5>
                                <p class="links">
                                    <a href="salestrap/portfolio-single.html"> <i class="fa fa-link"></i></a>
                                    <a href="salestrap/images/portfolio/p1.jpg" data-rel="prettyPhoto" class="img-responsive">
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio logo graphic">
                        <figure>
                        <img src="salestrap/images/portfolio/p2.jpg" alt="" />
                            <figcaption>
                                <h5>Creative Zoe</h5>
                                <p class="links">
                                    <a href="salestrap/portfolio-single.html"> <i class="fa fa-link"></i></a>
                                    <a href="salestrap/images/portfolio/p2.jpg"  data-rel="prettyPhoto" class="img-responsive">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                </p>
                                <p class="description">
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio graphic logo">
                        <figure>
                            <img src="salestrap/images/portfolio/p3.jpg" alt="" />
                            <figcaption>
                                <h5>Creative Zoe</h5>
                                <p class="links">
                                    <a href="salestrap/portfolio-single.html"> <i class="fa fa-link"></i></a>
                                    <a href="salestrap/images/portfolio/p3.jpg" data-rel="prettyPhoto" class="img-responsive">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                </p>
                                <p class="description">
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio web-design identity">
                        <figure>
                            <img src="salestrap/images/portfolio/p7.jpg" alt="" />
                            <figcaption>
                                <h5>Creative Zoe</h5>
                                <p class="links">
                                    <a href="salestrap/portfolio-single.html"> <i class="fa fa-link"></i></a>
                                    <a href="salestrap/images/portfolio/p7.jpg" data-rel="prettyPhoto" class="img-responsive">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                </p>
                                <p class="description">
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio logo web-design">
                        <figure>
                            <img src="salestrap/images/portfolio/p5.jpg" alt="" />
                            <figcaption>
                                <h5>Creative Zoe</h5>
                                <p class="links">
                                    <a href="salestrap/portfolio-single.html"> <i class="fa fa-link"></i></a>
                                    <a href="salestrap/images/portfolio/p5.jpg" data-rel="prettyPhoto" class="img-responsive">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                </p>
                                <p class="description">
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio logo graphic">
                        <figure>
                            <img src="salestrap/images/portfolio/p6.jpg" alt="" />
                            <figcaption>
                                <h5>Creative Zoe</h5>
                                <p class="links">
                                    <a href="salestrap/portfolio-single.html"> <i class="fa fa-link"></i></a>
                                    <a href="salestrap/images/portfolio/p6.jpg" data-rel="prettyPhoto" class="img-responsive">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                </p>
                                <p class="description">
                    ...
                    <div class="tab-content main-tab-content">
                          <div role="tabpanel" class="tab-pane active " id="home">
                                <div class="col-md-12 col-sm-9">
                                     <img src="salestrap/images/about/web1.png" alt="" class="img-responsive">
                                </div>
                                <div class="col-md-12 col-sm-9">
                                    <div class="c-tab">
                          ...
                          <div role="tabpanel" class="tab-pane" id="profile">
                                <div class="col-md-12 col-sm-9">
                                     <img src="salestrap/images/about/browse.png" alt="" class="img-responsive">
                                </div>
                                <div class="col-md-12 col-sm-9">
                                    <div class="c-tab">
                          ...
                          <div role="tabpanel" class="tab-pane" id="photo">
                               <div class="col-md-12 col-sm-9">
                                     <img src="salestrap/images/about/graphics.png" alt="" class="img-responsive">
                                </div>
                               <div class="col-md-12 col-sm-9">
                                    <div class="c-tab">
        ...
        <div class="row">
            ...
            <div id="owl-demo" class="owl-carousel owl-theme team-items">
                <div class="item text-center">
                    <div class="single-member">
                        <div class="overlay-hover">
                            <img src="salestrap/images/team/pic6.jpg" alt="" class="img-responsive">
                ...
                <div class="item text-center">
                    <div class="single-member">
                        <div class="overlay-hover">
                            <img src="salestrap/images/team/pic1.jpg" alt="" class="img-responsive">
                            <div class="overlay-effect">
                                <ul class="social list-inline">
                                    <li><a href=""><i class="fa fa-facebook"></i></a></li>
                                    <li><a href=""><i class="fa fa-google-plus"></i></a></li>
                ...
                <div class="item text-center">
                    <div class="single-member">
                        <div class="overlay-hover">
                            <img src="salestrap/images/team/pic2.jpg" alt="" class="img-responsive">
                            <div class="overlay-effect">
                                <ul class="social list-inline">
                                    <li><a href=""><i class="fa fa-facebook"></i></a></li>
                                    <li><a href=""><i class="fa fa-google-plus"></i></a></li>
                ...
                <div class="item text-center">
                    <div class="single-member">
                        <div class="overlay-hover">
                            <img src="salestrap/images/team/pic5.jpg" alt="" class="img-responsive">
                            <div class="overlay-effect">
                                <ul class="social list-inline">
                                    <li><a href=""><i class="fa fa-facebook"></i></a></li>
                                    <li><a href=""><i class="fa fa-google-plus"></i></a></li>
                ...
                <div class="item text-center">
                    <div class="single-member">
                        <div class="overlay-hover">
                            <img src="salestrap/images/team/pic4.jpg" alt="" class="img-responsive">
                            <div class="overlay-effect">
                                <ul class="social list-inline">
                                    <li><a href=""><i class="fa fa-facebook"></i></a></li>
                                    <li><a href=""><i class="fa fa-google-plus"></i></a></li>
             ...
             <div class="blog-timeline">
                <div id="owl-blog" class="owl-carousel owl-theme">
                    <div class="item ">
                        <div class="single_blog">
                            <div class="post_img text-center">
                               <a href="blog-single.html"><img src="salestrap/images/blog/pic3.jpg" alt="" class="img-responsive"></a>
                                <div class="post-date">
                                    <span>25</span> 6
                                </div>
                            </div>
                    ...
                    <div class="item ">
                        <div class="single_blog">
                            <div class="post_img text-center">
                                <a href="blog-single.html"><img src="salestrap/images/blog/pic4.jpg" alt="" class="img-responsive"></a>
                                <div class="post-date">
                                    <span>25</span> 6
                                </div>
                            </div>
                    ...
                    <div class="item ">
                        <div class="single_blog">
                            <div class="post_img text-center">
                                <a href="blog-single.html"><img src="salestrap/images/blog/pic2.jpg" alt="" class="img-responsive"></a>
                                <div class="post-date">
                                    <span>25</span> 6
                                </div>
                            </div>
                    ...
                    <div class="item ">
                        <div class="single_blog">
                            <div class="post_img text-center">
                                <a href="blog-single.html"><img src="salestrap/images/blog/pic5.jpg" alt="" class="img-responsive"> </a>
                                <div class="post-date">
                                    <span>25</span> 6
                                </div>
                            </div>
                    ...
                    <div class="item ">
                        <div class="single_blog">
                            <div class="post_img text-center">
                                <a href="blog-single.html"><img src="salestrap/images/blog/pic1.jpg" alt="" class="img-responsive"></a>
                                <div class="post-date">
                                    <span>25</span> 6
                                </div>
                            </div>
                    ...
                    <div id="testimonial-carousel" class="owl-carousel owl-theme text-center testimonial-slide">
                        <div class="item">
                          <div class="testimonial-thumb">
                            <img class="img-circle" src="salestrap/images/team/pic1.jpg" alt="testimonial" >
                          </div>
                        ...
                        <div class="item">
                          <div class="testimonial-thumb">
                            <img class="img-circle" src="salestrap/images/testimonial2.png" alt="testimonial" > 
                          </div>
                          <div class="testimonial-content">
                        ...
                        <div class="item">
                          <div class="testimonial-thumb">
                            <img class="img-circle" src="salestrap/images/team/pic6.jpg" alt="testimonial" >
                          </div>
                          <div class="testimonial-content">
        ...
        <div class="row wow fadeInLeft">
          <div id="client-carousel" class="col-sm-12 owl-carousel owl-theme text-center client-carousel">
            <div class="item client_logo">
              <a href="#">
                <img src="salestrap/images/clients/client1.png" alt="client" class="img-responsive">
              </a>
            </div>
            <div class="item client_logo">
              <a href="#">
                <img src="salestrap/images/clients/client2.png" alt="client" class="img-responsive">
              </a>
            </div>
            <div class="item client_logo">
              <a href="#">
                <img src="salestrap/images/clients/client3.png" alt="client" class="img-responsive">
              </a>
            </div>
            <div class="item client_logo">
              <a href="#">
                <img src="salestrap/images/clients/client4.png" alt="client" class="img-responsive">
              </a>
            </div>
            <div class="item client_logo">
              <a href="#">
                <img src="salestrap/images/clients/client5.png" alt="client" class="img-responsive">
              </a>
            </div>
            <div class="item client_logo">
              <a href="#">
                <img src="salestrap/images/clients/client6.png" alt="client" class="img-responsive">
              </a>
            </div>
            <div class="item client_logo">
              <a href="#">
                <img src="salestrap/images/clients/client7.png" alt="client" class="img-responsive">
              </a>
            </div>
            <div class="item client_logo">
              <a href="#">
                <img src="salestrap/images/clients/client8.png" alt="client" class="img-responsive">
              </a>
            </div>
...
<!-- Javascript Files
    ...
    <!-- initialize jQuery Library -->
		...
		<!-- initialize jQuery Library -->
        <!-- Main jquery -->
		    <script type="text/javascript" src="salestrap/js/jquery.js"></script>
        <!-- Bootstrap jQuery -->
         <script src="salestrap/js/bootstrap.min.js"></script>
        <!-- Owl Carousel -->
        <script src="salestrap/js/owl.carousel.min.js"></script>
        <!-- Isotope -->
        <script src="salestrap/js/jquery.isotope.js"></script>
        <!-- Pretty Photo -->
		    <script type="text/javascript" src="salestrap/js/jquery.prettyPhoto.js"></script>
        <!-- SmoothScroll -->
        <script type="text/javascript" src="salestrap/js/smooth-scroll.js"></script>
        <!-- Image Fancybox -->
        <script type="text/javascript" src="salestrap/js/jquery.fancybox.pack.js?v=2.1.5"></script>
        <!-- Counter  -->
        <script type="text/javascript" src="salestrap/js/jquery.counterup.min.js"></script>
        <!-- waypoints -->
        <script type="text/javascript" src="salestrap/js/waypoints.min.js"></script>
        <!-- Bx slider -->
        <script type="text/javascript" src="salestrap/js/jquery.bxslider.min.js"></script>
        <!-- Scroll to top -->
        <script type="text/javascript" src="salestrap/js/jquery.scrollTo.js"></script>
        <!-- Easing js -->
        <script type="text/javascript" src="salestrap/js/jquery.easing.1.3.js"></script>
   		 <!-- PrettyPhoto -->
        <script src="salestrap/js/jquery.singlePageNav.js"></script>
      	<!-- Wow Animation -->
        <script type="js/javascript" src="salestrap/js/wow.min.js"></script>
        <!-- Google Map  Source -->
        <script type="text/javascript" src="salestrap/js/gmaps.js"></script>
			 <!-- Custom js -->
        <script src="salestrap/js/custom.js"></script>
	     <script>

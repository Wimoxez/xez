...
<head>
	...
	<!-- Bootstrap CSS -->
	<link rel="stylesheet" href="gaugex/css/bootstrap.min.css" type="text/css">

	<!-- Styles -->
	<link rel="stylesheet" href="gaugex/js/owl-carousel/owl.carousel.css">
	<link rel="stylesheet" href="gaugex/js/owl-carousel/owl.theme.css">
	<link rel="stylesheet" href="gaugex/js/owl-carousel/owl.transitions.css">
	<link rel="stylesheet" href="gaugex/js/rs-plugin/css/settings.css">
	<link rel="stylesheet" href="gaugex/js/flexslider/flexslider.css">
	<link rel="stylesheet" href="gaugex/js/isotope/isotope.css">
	<link rel="stylesheet" href="gaugex/css/jquery-ui.css">
	<link rel="stylesheet" href="gaugex/js/magnific-popup/magnific-popup.css">
	<link rel="stylesheet" href="gaugex/css/style.css">
	...
	<!-- Icon Fonts -->
	<link rel="stylesheet" href="gaugex/css/icomoon/style.css" type="text/css">
	<link rel="stylesheet" href="gaugex/font-awesome/css/font-awesome.min.css" type="text/css">

	<!-- SKIN -->
	<link rel="stylesheet" href="gaugex/css/color-scheme/default-black.css" type="text/css">
		...
		<div class="container">
			<div class="navbar yamm navbar-default">
				<div class="navbar-header">
					...
					<a href="gaugex.jsp" class="navbar-brand">Gaugex</a>
				</div>
				...
				<div id="navbar-collapse-1" class="navbar-collapse collapse navbar-right">
					<ul class="nav navbar-nav">
						<li class="page-scroll"><a href="#page-top">Features</a></li>
						<li class="page-scroll"><a href="#1">Customers</a></li>
						<li class="page-scroll"><a href="#2">Pricing</a></li>
						<li class="page-scroll"><a href="#3">Support</a></li>
			...
			<div class="tp-banner" >
				<ul>
					<li data-transition="fade" data-slotamount="7" data-masterspeed="2000" data-saveperformance="on"  data-title="Ken Burns Slide">
						<!-- MAIN IMAGE -->
						<img src="gaugex/images/dummy.png"  alt="2" data-lazyload="gaugex/images/slider/1/2.jpg" data-bgposition="right top" data-kenburns="off" data-duration="12000" data-ease="Power0.easeInOut" data-bgfit="115" data-bgfitend="100" data-bgpositionend="center bottom">
						...
						<a href="http://ckthemes.com/html/maxima/maxima/index.html" alt="PayPal – The safer, easier way to pay online." class="pull-left tp-caption lfb tp-resizeme rs-parallaxlevel-0"
							data-x="380"
							data-y="400"
							...
							<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
									...
									<button border="0" name="submit" alt="PayPal – The safer, easier way to pay online." class="tp-caption lfb tp-resizeme rs-parallaxlevel-0"
							data-x="550"
							data-y="400"
							data-customin="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
							data-speed="500"
							...
							transition: .4s;
							;"
							 border="0" name="submit" alt="PayPal – The safer, easier way to pay online." class="button btn-border btn-small"><i class="icon-bag"></i>&nbsp; Pro Version</button>
								</form>
					...
					<!-- SLIDE  -->
										<li data-transition="fade" data-slotamount="7" data-masterspeed="2000" data-saveperformance="on"  data-title="Ken Burns Slide">
						<!-- MAIN IMAGE -->
						<img src="gaugex/images/dummy.png"  alt="2" data-lazyload="images/slider/1/1.jpg" data-bgposition="right top" data-kenburns="off" data-duration="12000" data-ease="Power0.easeInOut" data-bgfit="115" data-bgfitend="100" data-bgpositionend="center bottom">
						<div class="tp-caption tentered_white_huge lft tp-resizeme" data-endspeed="300" data-easing="Power4.easeOut" data-start="400" data-speed="600" data-y="280" data-hoffset="0" data-x="center"
							style="    color: #fff;
							text-transform: uppercase;
							font-size: 40px;
						...
						<a href="http://ckthemes.com/html/maxima/maxima/index.html" alt="PayPal – The safer, easier way to pay online." class="pull-left tp-caption lfb tp-resizeme rs-parallaxlevel-0"
							...
							transition: .4s;
							;"
							 border="0" name="submit" alt="" class="button btn-border btn-small"><i class="icon-bag"></i>&nbsp; Pro Version</button>
								</form>
					</li>
					</ul>
	...
	<div class="container-fluid no-padding" >
		<div class="container padding80">
			<div class="col-md-8 col-md-offset-2 text-center space50" id="1">
				...
				<p>Lorem ipsum dolor sit amet, viverra non, semper suscipit, posuere a, pede. Donec nec justo eget felis facilisis fermentum. Aliquam porttitor mauris sit amet orci. </p>
			</div>
			<div class="container">
...
<div class="container">
			...
			<ul class="filter" data-option-key="filter">
				...
				<div id="portfolio-home" class="isotope folio-boxed-3col" style="position: relative; height: 867px;">
					<div class="project-item branding" style="position: absolute; left: 0px; top: 0px;">
						<a href="./portfolio-single-slider.html">
							<div class="project-gal">
								<img src="gaugex/images/projects/1.jpg" class="img-responsive" alt="">
					...
					<div class="project-item illustration web-design illustration" style="position: absolute; left: 449px; top: 0px;">
						<a href="./portfolio-single-slider.html">
							<div class="project-gal">
								<img src="gaugex/images/projects/2.jpg" class="img-responsive" alt="">
								<div class="overlay-folio2">
									<div class="project-info">
					...
					<div class="project-item illustration print" style="position: absolute; left: 899px; top: 0px;">
						<a href="./portfolio-single-slider.html">
							<div class="project-gal">
								<img src="gaugex/images/projects/3.jpg" class="img-responsive" alt="">
								<div class="overlay-folio2">
									<div class="project-info">
										<h2>Vestibulum auctor</h2>
										<p>Image Gallery</p>
					...
					<div class="project-item web-design" style="position: absolute; left: 0px; top: 289px;">
						<a href="./portfolio-single-slider.html">
							<div class="project-gal">
								<img src="gaugex/images/projects/4.jpg" class="img-responsive" alt="">
								<div class="overlay-folio2">
									<div class="project-info">
										<h2>Vestibulum auctor</h2>
										<p>Image Gallery</p>
					...
					<div class="project-item branding" style="position: absolute; left: 449px; top: 289px;">
						<a href="./portfolio-single-slider.html">
							<div class="project-gal">
								<img src="gaugex/images/projects/5.jpg" class="img-responsive" alt="">
								<div class="overlay-folio2">
									<div class="project-info">
										<h2>Vestibulum auctor</h2>
										<p>Image Gallery</p>
					...
					<div class="project-item illustration web-design print" style="position: absolute; left: 899px; top: 289px;">
						<a href="./portfolio-single-slider.html">
							<div class="project-gal">
								<img src="gaugex/images/projects/6.jpg" class="img-responsive" alt="">
								<div class="overlay-folio2">
									<div class="project-info">
										<h2>Vestibulum auctor</h2>
										<p>Image Gallery</p>
		...
		<div class="container padding70" >
			<div class="text-center space40" id="4">
				<h2 class="title uppercase">Key Features</h2>
			...
			<div class="row">
				...
				<div class="col-sm-4 col-sm-pull-4">
					<div> <img src="gaugex/images/other/3.png" class="img-responsive center-block" alt=""> </div>
				</div>
			</div>
		</div>
		...
		<div class="container home-blog" id="5">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="hb-info">
						<div class="hb-thumb">
							<img src="gaugex/images/blog/1.jpg" class="img-responsive" alt=""/>
							<div class="date-meta">
				...
				<div class="col-md-4">
					<div class="hb-info">
						<div class="hb-thumb">
							<img src="gaugex/images/blog/2.jpg" class="img-responsive" alt=""/>
							<div class="date-meta">
				...
				<div class="col-md-4">
					<div class="hb-info">
						<div class="hb-thumb">
							<img src="gaugex/images/blog/3.jpg" class="img-responsive" alt=""/>
							<div class="date-meta">
				...
				<ul class="shop-grid">
							...
							<div class="product">
								<div class="text-center">
									<div class="product-thumbnail">
										<img src="gaugex/images/shop/1.jpg" class="img-responsive" alt="">
						...
						<li>
							<div class="product">
								...
								<div class="text-center">
									<div class="product-thumbnail">
										<img src="gaugex/images/shop/2.jpg" class="img-responsive" alt="">
										<div class="product-overlay">
											<a class="product-overlay-link" href="#"><i class="fa fa-search-plus"></i></a>
											<a class="product-overlay-cart" href="#"><i class="fa fa-cart-plus"></i></a>
										</div>
						...
						<li>
							<div class="product">
								<div class="text-center">
									<div class="product-thumbnail">
										<img src="gaugex/images/shop/3.jpg" class="img-responsive" alt="">
										<div class="product-overlay">
											<a class="product-overlay-link" href="#"><i class="fa fa-search-plus"></i></a>
											<a class="product-overlay-cart" href="#"><i class="fa fa-cart-plus"></i></a>
										</div>
		...
		<div class="clients container">
			<div id="carousel_five" class="owl-carousel">
				<div class="item client-logo">
					<a href="#"><img src="gaugex/images/clients/1.png" class="img-responsive" alt=""/></a>
				</div>
				<div class="item client-logo">
					<a href="#"><img src="gaugex/images/clients/2.png" class="img-responsive" alt=""/></a>
				</div>
				<div class="item client-logo">
					<a href="#"><img src="gaugex/images/clients/3.png" class="img-responsive" alt=""/></a>
				</div>
				<div class="item client-logo">
					<a href="#"><img src="gaugex/images/clients/4.png" class="img-responsive" alt=""/></a>
				</div>
				<div class="item client-logo">
					<a href="#"><img src="gaugex/images/clients/5.png" class="img-responsive" alt=""/></a>
				</div>
				<div class="item client-logo">
					<a href="#"><img src="gaugex/images/clients/6.png" class="img-responsive" alt=""/></a>
				</div>
				<div class="item client-logo">
					<a href="#"><img src="gaugex/images/clients/7.png" class="img-responsive" alt=""/></a>
				</div>
			</div>
		</div>
	...
	<footer>
		<div class="container">
			<div class="row">
			    ...
			    <img src="gaugex/images/basic/logo-ico.png" class="img-responsive space20" width="262" alt=""/>
			  ...
			  <ul class="f-posts">
						...
						<li>
							<img src="gaugex/images/blog/4.jpg" class="img-responsive" alt=""/>
							<h5><a href="#">Lorem ipsum post title</a></h5>
							<p><i class="fa fa-comments"></i> 5 Comments</p>
						</li>
					</ul>
	...
	<div class="footer-bottom">
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					<p>&copy; Copyright 2015. Maxima. Designed by <a href="http://www.ckthemes.com" target="_blank"> CK Themes</a></p>
				</div>
				<div class="col-md-4">
...
<div class="otheritem">
<ul class="fivecol">
	<li><a href="https://themeforest.net/item/ray-app-responsive-wordpress-theme/9740730?ref=CKThemes" target="_blank"><img alt="App Landing WordPress Theme" src="banner/ray_220_65.png" /> </a> </li>
	<li><a href="https://themeforest.net/item/select-responsive-landing-page-wordpress-theme/12043075?ref=CKThemes" target="_blank"><img alt="Responsive Landing Page WordPress Theme" class="noborder" src="banner/select_220_65.png" /></a> </li>
	<li><a href="https://themeforest.net/item/boson-wordpress-theme-page-builder/8645496?ref=CKThemes" target="_blank"><img alt="Boson - Business WordPress Theme with Page Builder" src="banner/boson_220_65.png" /> </a> </li>
	<li><a href="https://themeforest.net/item/rica-responsive-restaurant-wordpress-theme/15741077?ref=CKThemes" target="_blank"><img alt="Business Multipurpose HTML5 Template" src="banner/rica_220_65_with_bg.png" /> </a> </li>
	<li><a href="https://themeforest.net/item/boson-responsive-multipurpose-html5-template/11043414?ckthemes" target="_blank"><img alt="Portfolio Demo Page" src="banner/boson_html_220_65.png" /> </a></li>
	<li style="display: none"><a href="https://themeforest.net/item/lawyerdesk-multipage-lawyer-and-attorney-responsive-theme/16055198?ref=CKThemes" target="_blank"><img alt="Multipage Lawyer and Attorney Responsive Theme" src="banner/lawyerdesk_220_65.png" /> </a> </li>
</ul>
</div>
...
<div class="b-settings-panel">
	...
	<div class="settings-section color-list">
		<div data-src="gaugex/css/color-scheme/moderate-green.css" style="background: #8ec249"></div>
		<div data-src="gaugex/css/color-scheme/vivid-blue.css" style="background: #228dff"></div>
		<div data-src="gaugex/css/color-scheme/orange.css" style="background: #fa6900"></div>
		<div data-src="gaugex/css/color-scheme/brown.css" style="background: #a68c69"></div>
		<div data-src="gaugex/css/color-scheme/yellow.css" style="background: #fabe28"></div>
		<div data-src="gaugex/css/color-scheme/violet.css" style="background: #ba01ff"></div>
		<div data-src="gaugex/css/color-scheme/strong-cyan.css" style="background: #00b9bd"></div>
		<div data-src="gaugex/css/color-scheme/soft-cyan.css" style="background: #4bd5ea"></div>
		<div data-src="gaugex/css/color-scheme/red.css" style="background: #ff0104"></div>
		<div data-src="gaugex/css/color-scheme/lite-brown.css" style="background: #f3a76d"></div>
		<div data-src="gaugex/css/color-scheme/lime-green.css" style="background: #3bdbad"></div>
		<div data-src="gaugex/css/color-scheme/light-voilet.css" style="background: #aaa5ff"></div>
		<div data-src="gaugex/css/color-scheme/gray-green.css" style="background: #697060"></div>
		<div data-src="gaugex/css/color-scheme/gray-cyan.css" style="background: #aeced2"></div>
		<div data-src="gaugex/css/color-scheme/de-green.css" style="background: #b6cd71"></div>
		<div data-src="gaugex/css/color-scheme/cream.css" style="background: #e0d6b2"></div>
...
<!-- jQuery -->
<script src="gaugex/js/jquery.js"></script>

<!-- Plugins -->
<script src="gaugex/js/bootstrap.min.js"></script>
<script src="gaugex/js/menu.js"></script>
<script src="gaugex/js/owl-carousel/owl.carousel.min.js"></script>
<script src="gaugex/js/rs-plugin/js/jquery.themepunch.tools.min.js"></script>   
<script src="gaugex/js/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
<script src="gaugex/js/jquery.easing.min.js"></script>
<script src="gaugex/js/isotope/isotope.pkgd.js"></script>
<script src="gaugex/js/jflickrfeed.min.js"></script>
<script src="gaugex/js/tweecool.js"></script>
<script src="gaugex/js/flexslider/jquery.flexslider.js"></script>
<script src="gaugex/js/easypie/jquery.easypiechart.min.js"></script>
<script src="gaugex/js/jquery-ui.js"></script>
<script src="gaugex/js/jquery.appear.js"></script>
<script src="gaugex/js/jquery.inview.js"></script>
<script src="gaugex/js/jquery.countdown.min.js"></script>
<script src="gaugex/js/jquery.sticky.js"></script>
<script src="gaugex/js/magnific-popup/jquery.magnific-popup.min.js"></script>
<script src="gaugex/js/jquery.easing/jquery.easing.js"></script>

<script src="gaugex/js/main.js"></script>

<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?sensor=false"></script>
<script src="gaugex/js/gmaps/greyscale.js"></script>

...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="shortcut icon" href="carrers/favicon.ico" type="image/x-icon">
        <link rel="icon" href="carrers/favicon.ico" type="image/x-icon">

        <link rel="stylesheet" href="carrers/css/normalize.css">
        <link rel="stylesheet" href="carrers/css/font-awesome.min.css">
        <link rel="stylesheet" href="carrers/css/fontello.css">
        <link rel="stylesheet" href="carrers/css/animate.css">        
        <link rel="stylesheet" href="carrers/css/bootstrap.min.css">
        <link rel="stylesheet" href="carrers/css/owl.carousel.css">
        <link rel="stylesheet" href="carrers/css/owl.theme.css">
        <link rel="stylesheet" href="carrers/css/owl.transitions.css">
        <link rel="stylesheet" href="carrers/style.css">
        <link rel="stylesheet" href="carrers/responsive.css">
        <script src="carrers/js/vendor/modernizr-2.6.2.min.js"></script>
    </head>
    <body>
        ...
        <nav class="navbar navbar-default">
          <div class="container">
            ...
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#"><img src="carrers/img/logo.png" alt=""></a>
            </div>
        ...
        <div class="slider-area">
            <div class="slider">
                <div id="bg-slider" class="owl-carousel owl-theme">
                  ...
                  <div class="item"><img src="carrers/img/slider-image-3.jpg" alt="Mirror Edge"></div>
                  <div class="item"><img src="carrers/img/slider-image-2.jpg" alt="The Last of us"></div>
                  <div class="item"><img src="carrers/img/slider-image-1.jpg" alt="GTA V"></div>
                ...
                <div class="row how-it-work text-center">
                    <div class="col-md-4">
                        <div class="single-work wow fadeInUp" data-wow-delay="0.8s">
                            <img src="carrers/img/how-work1.png" alt="">
                    ...
                    <div class="col-md-4">
                        <div class="single-work  wow fadeInUp"  data-wow-delay="0.9s">
                            <img src="carrers/img/how-work2.png" alt="">
                            <h3>Searching for the best job</h3>
                            <p>Using the outcomes from the job, we will put together a plan for the most effective marketing strategy to get the best results.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="single-work wow fadeInUp"  data-wow-delay="1s">
                            <img src="carrers/img/how-work3.png" alt="">
                            <h3>Searching for the best job</h3>
                            <p>Using the outcomes from the job, we will put together a plan for the most effective marketing strategy to get the best results.</p>
                        </div>
                    </div>
                      ...
                      <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="employeers">
                            <ul class="list-inline">
                                <li>
                                    <a href="">
                                        <img src="carrers/img/employee4.png" alt="">
                                        <div class="overlay"><h3>Instagram</h3></div>
                                    </a>
                                </li>
                                <li>
                                    <a href="">
                                        <img src="carrers/img/employee5.png" alt="">
                                        <div class="overlay"><h3>Microsoft</h3></div>
                                    </a>
                                </li>
                                <li>
                                    <a href="">
                                        <img src="carrers/img/employee6.png" alt="">
                                        <div class="overlay"><h3>Dribbble</h3></div>
                                    </a>
                                </li>
                                <li>
                                    <a href="">
                                        <img src="carrers/img/employee1.png" alt="">
                                        <div class="overlay"><h3>Beats Music</h3></div>
                                    </a>
                                </li>
                                <li>
                                    <a href="">
                                        <img src="carrers/img/employee2.png" alt="">
                                        <div class="overlay"><h3>Facebook</h3></div>
                                    </a>
                                </li>
                                <li>
                                    <a href="">
                                        <img src="carrers/img/employee3.png" alt="">
                        ...
                        <div class="job-posts table-responsive">
                            <table class="table">
                                <tr class="odd wow fadeInUp" data-wow-delay="1s">
                                    <td class="tbl-logo"><img src="carrers/img/job-logo1.png" alt=""></td>
                                ...
                                <tr class="even wow fadeInUp" data-wow-delay="1.1s">
                                    <td class="tbl-logo"><img src="carrers/img/job-logo2.png" alt=""></td>
                                ...
                                <tr class="odd wow fadeInUp" data-wow-delay="1.2s">
                                    <td class="tbl-logo"><img src="carrers/img/job-logo3.png" alt=""></td>
                                ...
                                <tr class="even wow fadeInUp" data-wow-delay="1.3s">
                                    <td class="tbl-logo"><img src="carrers/img/job-logo4.png" alt=""></td>
                                ...
                                <tr class="odd wow fadeInUp" data-wow-delay="1.4s">
                                    <td class="tbl-logo"><img src="carrers/img/job-logo5.png" alt=""></td>
                        ...
                        <div id="testimonial-slider">
                            <div class="item">
                                ...
                                <div class="client-face wow fadeInRight" data-wow-delay=".9s"> 
                                    <img src="carrers/img/client-face1.png" alt="">
                                </div>
                            </div>
                            <div class="item">
                                <div class="client-text">                                
                                ...
                                <div class="client-face">
                                    <img src="carrers/img/client-face2.png" alt="">
                                </div>
                            </div>
                            <div class="item">
                                <div class="client-text">                                
                ...
                <div class="row footer">
                    <div class="col-md-4">
                        <div class="single-footer">
                            <img src="carrers/img/footer-logo.png" alt="" class="wow pulse" data-wow-delay="1s">
        ...
        <script>window.jQuery || document.write('<script src="carrers/js/vendor/jquery-1.10.2.min.js"><\/script>')</script>
        <script src="carrers/js/bootstrap.min.js"></script>
        <script src="carrers/js/owl.carousel.min.js"></script>
        <script src="carrers/js/wow.js"></script>
        <script src="carrers/js/main.js"></script>
    </body>
</html>

...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">  
  <div class="container">  
    ...
    <span class="sr-only"></span>
      ...
      <a class="navbar-brand" href="#"><img src="Images_content/logo.png" height="30px" width= "50px"></a>  
    </div> 
    ...
    <ul class="nav navbar-nav">  
      ...
      <ul class="dropdown-menu">  
          ...
          <li><a href="Cloud.jsp">Wimoxez Cloud</a></li>
           <li><a href="Entrepreneur.jsp">Wimoxez for Entrepreneur</a></li>
        </ul>
        </li> 
       <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Products <span class="caret"></span></a>
        ...
        <li><a href="Trendus.jsp">Trendus</a></li>  
         ...
         <li><a href="Salestrap.jsp">Salestrap</a></li>
...
<div class="row">
  ...
  <div class="col-sm-6 col-md-4">
    ...
    <div class="t">
   <h1> Design and devloped at WIMOXEZ Labs</h1>
 ...
 <li> <a href="Roadpad.jsp">Roadpad</a></li>
   <li> <a href="Praesentare.jsp">Praesentare</a></li>
    <li> <a href="Analyticsore.jsp">Analyticsore</a></li>
     <li> <a href="Reinforce.jsp">Reinforce</a></li>
     <li>  <a href="Payxez.jsp">Payxez</a></li>
       <li> <a href="Accord.jsp">Accord</a></li></ul>
  </div>
    <div class="col-xs-3">
   <ul>
   <li> <h3>Social</h3></li>

...
<html lang="en">
    <head>
        ...
        <title>Gaze</title>
        <link rel="shortcut icon" type="image/x-icon" href="gaze/images/logo.png"/>

        <link href="gaze/css/bootstrap.min.css" rel="stylesheet">
        <link href="gaze/css/bootstrap-theme.min.css" rel="stylesheet">

        <link href="gaze/css/owl.carousel.css" rel="stylesheet">
        <link href="gaze/css/owl.theme.default.min.css" rel="stylesheet">

        <link href="gaze/css/magnific-popup.css" rel="stylesheet">

        <link href="gaze/css/style.css" rel="stylesheet">
 ...
 .navbar-default,
  ...
  background-color:white;
    ...
    <body>
        <div id="menu-item" class="menu-item hide-menu">
            <div class="container">
                <ul>
                    ...
                    <a href="#about"><li>Explore</li></a>
                    <a href="#expertise"><li>Pricing</li></a>
                    <a href="#workstation"><li>Support</li></a>
        ...
        <div class="main">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            ...
                            <img src="custrel/images/signature.png">
            ...
            <section class="vira-quote section bg-img">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <img class="quote" src="gaze/images/quote.png">
                           <p>
                               A user interface is like a joke. If you have to explain it, it’s not that good.
                           </p>
                           <p class="author">Martin leBlance, Iconfinder</p>
                           <img src="gaze/images/mouse.png">
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container">
                    ...
                    <div id="workstation-slider" class="owl-carousel">
                        <div class="item">
                            <div class="vira-card">
                                <div class="vira-card-header">
                                    <img class="img-responsive" src="gaze/images/4.jpg">
                                </div>
                                <div class="vira-card-content">
                        ...
                        <div class="item">
                            <div class="vira-card">
                                <div class="vira-card-header">
                                    <img class="img-responsive" src="gaze/images/5.jpg">
                                </div>
                                <div class="vira-card-content">
                        ...
                        <div class="item">
                            <div class="vira-card">
                                <div class="vira-card-header">
                                    <img class="img-responsive" src="gaze/images/6.jpg">
                                </div>
                                <div class="vira-card-content">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="vira-card">
                                <div class="vira-card-header">
                                    <img class="img-responsive" src="gaze/images/8.jpg">
                                </div>
                                <div class="vira-card-content">
                                    <h3>Pink Floyd</h3>
                                    <p>
                        ...
                        <div class="col-sm-4">
                            <div class="vira-card">
                                <div class="vira-card-header">
                                    <img class="img-responsive" src="gaze/images/9.jpg">
                                </div>
                                <div class="vira-card-content">
                                    <h3>Eric Clapton</h3>
                                    <p>
                        ...
                        <div class="col-sm-4">
                            <div class="vira-card">
                                <div class="vira-card-header">
                                    <img class="img-responsive" src="gaze/images/10.jpg">
                                </div>
                                <div class="vira-card-content">
                                    <h3>Elton Jhon</h3>
                                    <p>
        ...
        <script src="gaze/js/jquery-3.1.1.js"></script>
        <script src="gaze/js/bootstrap.min.js"></script>
        <script src="gaze/js/owl.carousel.min.js"></script>
        <script src="https://use.fontawesome.com/55b73bf748.js"></script>
        <script src="gaze/js/jquery.magnific-popup.js"></script>
        <script src="gaze/js/script.js"></script>
    </body>
</html>
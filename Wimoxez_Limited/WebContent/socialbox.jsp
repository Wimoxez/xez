...
<head>
	...
	<link rel=stylesheet href="socialbox/css/main.css">
	<!--[if lte IE 8]>
	<link rel=stylesheet href="socialbox/css/ie.css">
	<![endif]-->
		<script src="socialbox/js/vendor/modernizr.js"></script>
...
<body>
  <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
      ...
      <li class="active"><a href="analyticsore.jsp"><b>Socialbox</b></a></li> 
	...
	<div class=level>
		...
		<img src="socialbox/img/v2/iphone6.min.png" alt class="mb-80 hidden-xs iphone-inline">
	...
	<div class="level level-img-right">
		...
		<div class="container xs-mb-30">
			<img class=img-right-sprite src="socialbox/img/v2/iphone-bg-lg.min.png" alt>
		...
		<div class="visible-xs xs-mw xs-mb-40">
			<img src="socialbox/img/v2/iphone-mobile.min.png" alt>
		</div>
	...
	<script>window.jQuery || document.write('<script src="socialbox/js/vendor/jquery-1.11.1.min.js"><\/script>')</script>

	<script src="socialbox/js/bootstrap.min.js"></script>
	<script src="socialbox/js/dropdown.js"></script>
	<script src="socialbox/js/modal.js"></script>
	<script src="socialbox/js/main.js"></script>
	<!-- //-end- concat_js -->
